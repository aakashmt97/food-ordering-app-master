...
import { Button, Tab, Tabs, IconButton, FormLabel, RadioGroup, FormControlLabel, Radio, Divider } from '@material-ui/core';
                    ...
                    <div className="panel-step">
                                        ...
                                        {index === 0 ?
                                            <div className="address-container">
                                                <Tabs className="panel-address" value={this.state.value} onChange={this.tabsChangeHandler}>
                                                    <Tab label="EXISTING ADDRESS" className="tab" />
                                                    <Tab label="NEW ADDRESS" className="tab" />
                                                </Tabs>
                                                {this.state.value === 0 && //Based on the value showing the tab value = 0 for existing address
                                                    <TabContainer>
                                                        {this.state.addresses.length !== 0 ?
                                                            <GridList className="gridList" cols={this.state.noOfColumn} spacing={2} cellHeight='auto'>
                                                                {this.state.addresses.map(address => (
                                                                    <GridListTile className="gridListTile" key={address.id} style={{ borderColor: address.selected ? "rgb(224,37,96)" : "white" }}>
                                                                        <div className="grid-list-tile-container">
                                                                            ...
                                                                            <IconButton className="addressCheckButton" onClick={() => this.highlightedAddressEventHandler(address.id)}>
                                                ...
                                                {this.state.value === 1 && //Value = 1 for save address tab
                                                    <TabContainer className="saveAddressForm">
                                                        ...
                                                        <FormControl required className="formControl">
                                                            ...
                                                            <Select id="state" className="selectField" state={this.state.selectedState} onChange={this.stateChangeEventHandler} MenuProps={{ style: { marginTop: '50px', maxHeight: '300px' } }} value={this.state.selectedState}>
                                                        ...
                                                        <br />
                                                        <br />
                                                        <Button variant="contained" className="formButton" color="secondary" onClick={this.saveAddressClickHandler}>SAVE ADDRESS</Button>
                                                    </TabContainer>
                                                }
                                            </div>
                                            :
                                            <div className="payment-container">
                                                <FormControl component="fieldset" className="radioFormControl">
                        ...
                        {this.state.activeStep === this.state.steps.length && (
                            <Paper square elevation={0} className="resetContainer">
                                ...
                                <Button onClick={this.changeButtonClickHandler} className="button">
                                    Change
                             </Button>
                            </Paper>
                        )}
                    ...
                    <div className="panel-summary">
                        <Card className="summary">
                            ...
                            <CardContent className="cardContent">
                                <Typography variant='subtitle1' component='p' className="restaurantName">{this.state.restaurantDetails.name}</Typography>
                                {this.state.cartItems.map(cartItem => (
                                    <div className="panel-menu-item" key={cartItem.id}>
                                        ...
                                        <Typography variant="subtitle1" component="p" className="menuItemName" id="summary-menu-item-name" >{cartItem.name[0].toUpperCase() + cartItem.name.slice(1)}</Typography>
                                        <Typography variant="subtitle1" component="p" className="itemQuantity">{cartItem.quantity}</Typography>
                                        <div className="panel-summary-item-price">
                                            <i className="fa fa-inr" aria-hidden="true" style={{ color: 'grey' }}></i>
                                            <Typography variant="subtitle1" component="p" className="itemPrice" id="summary-item-price">{cartItem.totalAmount.toFixed(2)}</Typography>
                                        </div>
                                    </div>
                                ))}
                                <div className="panel-coupon">
                                    <FormControl className="formControlCoupon">
                                        <InputLabel htmlFor="coupon">Coupon Code</InputLabel>
                                        <FilledInput id="coupon" className="couponInput" value={this.state.couponName} onChange={this.couponNameHandler} placeholder="Ex: FLAT30" />
                                    ...
                                    <Button variant="contained" color="default" className="applyButton" onClick={this.performApplyEventHandler} size="small">APPLY</Button>
                                </div>
                                ...
                                <div className="panel-label-amount">
                                    <Typography variant="subtitle2" component="p" className="netAmount" style={{ color: 'grey' }}>Discount</Typography>
                                    <div className="amount">
                                        <i className="fa fa-inr" aria-hidden="true" style={{ color: 'grey' }}></i>
                                ...
                                <div className="panel-label-amount">
                                    <Typography variant="subtitle2" component="p" className="netAmount">Net Amount</Typography>
                                    <div className="amount">
                                        <i className="fa fa-inr" aria-hidden="true" style={{ color: 'grey' }}></i>
                                        <Typography variant="subtitle1" component="p" className="itemPrice" id="summary-net-amount">{this.totalAmountCalculateHandler().toFixed(2)}</Typography>
                                    </div>
                                </div>

                                <Button variant="contained" color='primary' fullWidth={true} className="placeOrderButton" onClick={this.orderPlaceEventHandler}>PLACE ORDER</Button>
